...
1. You are givern the initial staring ppoint (0,0,N) of a rover
...
8. The grid may have obstacles. If given sequence of commands encounters an obstacle, the rover moves up to the last possible point and reports the obstacle e.g O:2:2:N
